...
export default function MenuScreen() {
    ...
    return (
      <SafeAreaView style={[styles.safe, { paddingTop: SAFE_TOP, backgroundColor: colors.background }]}>
        <View style={[styles.container, styles.center]}>
          ...
          <Text style={{ marginTop: 8, color: colors.text }}>Loading menu…</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (err) {
    return (
      <SafeAreaView style={[styles.safe, { paddingTop: SAFE_TOP, backgroundColor: colors.background }]}>
        <View style={[styles.container, styles.center]}>
          <Text style={{ color: colors.danger, fontWeight: "bold", marginBottom: 8 }}>
            Can't load products: {err}
          </Text>
          <Text style={{ fontSize: 12, color: colors.muted, marginBottom: 6 }}>Tried:</Text>
          <Text style={{ fontSize: 12, color: colors.muted }}>{`${API_URL}/products`}</Text>
          <Text style={{ fontSize: 12, color: colors.muted }}>{`${API_URL}/api/products`}</Text>
